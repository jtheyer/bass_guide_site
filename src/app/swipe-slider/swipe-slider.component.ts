...
export class SwipeSliderComponent {
  ...
  //   if (swiper.isEnd) {
  //     // all swiper events are run outside of ngzone, 
  //     //  ..so use ngzone.run or detectChanges to update the view.
  //     this.ngZone.run(() => {
...
// import SwiperCore, { SwiperOptions, Navigation, 
//Pagination, Scrollbar, A11y } from 'swiper';
